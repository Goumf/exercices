...
public class equation {
	...
	public static void main(String[] args) {
        ...
        Scanner scanner = new Scanner(System.in);     //system.in = données viennent du clavier
        double a, b, c, delta;

        System.out.print("Entrer une valeur pour a : ");    // system.out affiche un texte
        a = scanner.nextDouble();                           // lit le texte du scanner
